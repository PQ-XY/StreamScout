...
import com.xy.jupiter.dao.FavoriteDao;
import com.xy.jupiter.entity.db.Item;
import com.xy.jupiter.entity.db.ItemType;
import com.xy.jupiter.entity.response.Game;
...
public class RecommendationService {
    ...
    private List<Item> recommendByFavoriteHistory(
        ...
        // Count the favorite game IDs from the database for the given user. E.g. if the favorited game ID list is ["1234",
        // "2345", "2345", "3456"], the returned Map is {"1234": 1, "2345": 2, "3456": 1}
        ...
        sortedFavoriteGameIdListByCount.sort((Map.Entry<String, Long> e1, Map.Entry<String, Long> e2) -> Long
                .compare(e2.getValue(), e1.getValue())); // See also: https://stackoverflow.com/questions/109383/sort-a-mapkey-value-by-values
    ...
    // Return a map of Item objects as the recommendation result. Keys of the may are [Stream, Video, Clip]. Each key is
    // corresponding to a list of Items objects, each item object is a recommended item based on the previous favorite
    // records by the user.
